...
KEY_2 = b'00000000000000000000000000000001' # lenght must be 32

# k1 = binascii.unhexlify(KEY_1)
# k2 = binascii.unhexlify(KEY_2)
...
plaintext = [] # message to encode, will be random
